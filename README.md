...
3 tasks for the 2-week internship and 
...
A section that shows 3 features of the app (each with an icon and descriptionq
A section with 2–3 reviews or quotes from happy userj
A section with 3 pricing options (for example: Free, Pro, Teamq
...
Tools & Libraries:
HTML|JavaScript| CSS or Tailwind

Covered Topics
React | JSX | Responsive Design | Layout Design | Component Composition
Bonus
Add a small animation when each section appears while scrolling down the page.

Task 4: Create a Personal Blog Homepage
Description
 Build a homepage for a personal blog showing blog posts in a card layout.
 Add a simple header with the blog titlÆ
 Add a section that displays blog post cards (title, image, short description, and dateq
 Add a category filter to switch between types of posts (e.g., Tech, Travel, Foodq
...
Covered Topics
React | Props & State | Responsive Grid | Filtering | UI Layout | Conditional Rendering

Bonus
Add a search input to filter posts by title keyword.
